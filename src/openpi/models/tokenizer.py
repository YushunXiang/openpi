...
class PaligemmaTokenizer:
    def __init__(self, max_len: int = 48):
        ...
        path = download.maybe_download("/inspire/hdd/project/robot-reasoning/xiangyushun-p-xiangyushun/yushun/openpi/models/paligemma_tokenizer.model", gs={"token": "anon"})
